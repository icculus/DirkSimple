...
/* BEGIN DirkSimple hardcoded settings */
...
#define lodepng_free DirkSimple_free
#define lodepng_malloc DirkSimple_xmalloc
#define lodepng_realloc DirkSimple_xrealloc
/* END DirkSimple hardcoded settings */
